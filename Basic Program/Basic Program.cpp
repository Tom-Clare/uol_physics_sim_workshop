...
void InitScene()
{
	...
	//materials
	PxMaterial* default_material = physics->createMaterial(0.f, 0.2f, 0.3f);   //static friction, dynamic friction, restitution
	...
	box = physics->createRigidDynamic(PxTransform(PxVec3(0.f, 100.f, 0.f)));
	...
	//create a dynamic actor and place it 10 m above the ground
	box2 = physics->createRigidDynamic(PxTransform(PxVec3(0.f, 0.5f, 0.f)));
	//create a box shape of 1m x 1m x 1m size (values are provided in halves)
